...
export const user_available_time = [
    { value: 'LESS_THAN_ONE_HOUR', label: 'Menos de 1 hora' },
    { value: 'ONE_TO_TWO_HOURS', label: 'Entre 1 e 2 horas' },
    { value: 'TWO_TO_FOUR_HOURS', label: 'Entre 2 e 4 horas' },
    { value: 'MORE_THAN_FOUR_HOURS', label: 'Mais de 4 hora' },
];
